...
import { oppositeSide } from "../../domain/challenge";
import type { Challenge, ChallengeMatch } from "../../domain/types";
  ...
  return (
    <div className="page">
      <header className="page-header">
        ...
        <button className="icon-button" onClick={refresh} aria-label="Refresh challenge">
          <RefreshCw size={18} />
        </button>
      </header>
      ...
      <section className="detail-grid">
        ...
        <div className="panel">
          ...
          <button className="primary-button" onClick={match}>
            Match 1:1
          </button>
      ...
      <section className="panel">
        <div className="section-title">
          <h2>Share card</h2>
          <button className="icon-button" onClick={() => navigator.clipboard.writeText(window.location.href)} aria-label="Copy link">
            <Copy size={18} />
          </button>
        </div>
